...
#include "radar_interfaces/msg/detail/ground_truth__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const radar_interfaces::msg::GroundTruth & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.relative_landmark_range;
  }
  // Member: relative_landmark_angle
  {
    cdr << ros_message.relative_landmark_angle;
  }
  // Member: is_moving
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  radar_interfaces::msg::GroundTruth & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: relative_landmark_range
  {
    ...
    size_t item_size = sizeof(ros_message.relative_landmark_range[0]);
  ...
  // Member: relative_landmark_angle
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.relative_landmark_angle[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: is_moving
  ...
  // Member: relative_position
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.relative_position[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = radar_interfaces::msg::GroundTruth;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::GroundTruth *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_interfaces::msg::GroundTruth *>(
    untyped_ros_message);
...
{
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_GroundTruth__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_interfaces, msg, GroundTruth)() {
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_GroundTruth__handle;
}
