...
#include "radar_interfaces/msg/detail/landmark_estimate__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: range_bin
  {
    ...
    size_t item_size = sizeof(ros_message.range_bin[0]);
  ...
  // Member: heatmap
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.heatmap[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: angles_degree
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.angles_degree[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = radar_interfaces::msg::LandmarkEstimate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::LandmarkEstimate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_interfaces::msg::LandmarkEstimate *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LandmarkEstimate__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const radar_interfaces::msg::LandmarkEstimate *>(
...
static size_t _LandmarkEstimate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LandmarkEstimate(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LandmarkEstimate__callbacks = {
...
static rosidl_message_type_support_t _LandmarkEstimate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LandmarkEstimate__callbacks,
...
{
  return &radar_interfaces::msg::typesupport_fastrtps_cpp::_LandmarkEstimate__handle;
}
